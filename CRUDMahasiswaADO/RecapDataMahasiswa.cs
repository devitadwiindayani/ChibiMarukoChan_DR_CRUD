...
{
    public partial class RecapDataMahasiswa : Form
    {
        static string connectionString = "Data Source=LAPTOP-GO2648H1\\DEVITADWI;Initial Catalog=DBAkademikADO;User ID=sa;Password=sqldevita";
        ...
        private void RecapDataMahasiswa_Load(object sender, EventArgs e)
        {
